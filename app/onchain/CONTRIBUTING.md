...
///
/// # Errors
/// Returns `Error::InvalidAmount` if amount is less than min_amount
/// Returns `Error::PackageIdExists` if package ID already exists
/// Returns `Error::InsufficientFunds` if contract balance is insufficient
